...
import 'couponcenter_tab1_page.dart';
import 'models/coupon_center_my_vouchers_no_model.dart';

class CouponCenterMyVouchersNoScreen extends StatefulWidget {
  const CouponCenterMyVouchersNoScreen({Key? key}) : super(key: key);

  @override
  CouponCenterMyVouchersNoScreenState createState() =>
      CouponCenterMyVouchersNoScreenState();
      ...
      create:
          (context) => CouponCenterMyVouchersNoBloc(
            CouponCenterMyVouchersNoState(
              couponCenterMyVouchersNoModelObj: CouponCenterMyVouchersNoModel(),
            ),
          )..add(CouponCenterMyVouchersNoInitialEvent()),
      child: CouponCenterMyVouchersNoScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class CouponCenterMyVouchersNoScreenState
    extends State<CouponCenterMyVouchersNoScreen>
                  ...
                  Expanded(
                    child: Container(
                      child: TabBarView(
                        ...
                        children: [
                          Container(),
                          CouponcenterTab1Page.builder(context),
                        ],
                      ),
                    ),
                  ),
  ...
  /// Section Widget
  Widget _buildColumnearnticke(BuildContext context) {
    return Container(
      width: double.maxFinite,
