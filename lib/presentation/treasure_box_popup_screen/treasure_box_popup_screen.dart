...
import 'bloc/treasure_box_popup_bloc.dart';
import 'models/treasure_box_popup_model.dart';

class TreasureBoxPopupScreen extends StatelessWidget {
  const TreasureBoxPopupScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<TreasureBoxPopupBloc>(
      create:
          (context) => TreasureBoxPopupBloc(
            TreasureBoxPopupState(
              treasureBoxPopupModelObj: TreasureBoxPopupModel(),
            ),
          )..add(TreasureBoxPopupInitialEvent()),
      child: TreasureBoxPopupScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<TreasureBoxPopupBloc, TreasureBoxPopupState>(
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Text(
                                    "lbl_cash_voucher".tr.toUpperCase(),
                                    style:
                                        CustomTextStyles
