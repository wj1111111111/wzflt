...
import 'bloc/senior_mentoring_advanced_one_bloc.dart';
...
class SeniorMentoringAdvancedOneScreen extends StatelessWidget {
  const SeniorMentoringAdvancedOneScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<SeniorMentoringAdvancedOneBloc>(
      create:
          (context) => SeniorMentoringAdvancedOneBloc(
            SeniorMentoringAdvancedOneState(
              seniorMentoringAdvancedOneModelObj:
                  SeniorMentoringAdvancedOneModel(),
            ),
          )..add(SeniorMentoringAdvancedOneInitialEvent()),
      child: SeniorMentoringAdvancedOneScreen(),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: double.maxFinite,
                          child: BlocSelector<
                            SeniorMentoringAdvancedOneBloc,
                            SeniorMentoringAdvancedOneState,
                            SeniorMentoringAdvancedOneModel?
                          >(
                            selector:
                                (state) =>
                                    state.seniorMentoringAdvancedOneModelObj,
                            builder: (
                              context,
                              seniorMentoringAdvancedOneModelObj,
                            ) {
        ...
        child: BackdropFilter(
          ...
          child: Card(
            ...
            child: Container(
              height: 240.h,
              width: double.maxFinite,
              decoration: AppDecoration.gradientBlueACToIndigoC.copyWith(
                borderRadius: BorderRadiusStyle.circleBorder10,
              ),
              child: Stack(
                alignment: Alignment.center,
                        ...
                        return CarouselSlider.builder(
                          options: CarouselOptions(
                            ...
                            onPageChanged: (index, reason) {
                              context
                                  .read<SeniorMentoringAdvancedOneBloc>()
      ...
      child: Stack(
        ...
        children: [
          BlocSelector<
            ...
            SeniorMentoringAdvancedOneModel?
          >(
            selector: (state) => state.seniorMentoringAdvancedOneModelObj,
            builder: (context, seniorMentoringAdvancedOneModelObj) {
