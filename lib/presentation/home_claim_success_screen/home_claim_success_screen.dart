...
import 'bloc/home_claim_success_bloc.dart';
import 'models/home_claim_success_model.dart';

// ignore_for_file: must_be_immutable
class HomeClaimSuccessScreen extends StatelessWidget {
  HomeClaimSuccessScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<HomeClaimSuccessBloc>(
      create:
          (context) => HomeClaimSuccessBloc(
            HomeClaimSuccessState(
              homeClaimSuccessModelObj: HomeClaimSuccessModel(),
            ),
          )..add(HomeClaimSuccessInitialEvent()),
      child: HomeClaimSuccessScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HomeClaimSuccessBloc, HomeClaimSuccessState>(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                margin: EdgeInsets.only(bottom: 404.h),
                            ...
                            Align(
                              alignment: Alignment.bottomLeft,
                              child: Container(
                                margin: EdgeInsets.only(bottom: 336.h),
                                padding: EdgeInsets.symmetric(horizontal: 14.h),
                                decoration: AppDecoration.fs15.copyWith(
                                  borderRadius:
                                      BorderRadiusStyle.customBorderTL81,
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: AppDecoration.column405,
                                        child: Column(
                                          mainAxisSize: MainAxisSize.min,
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    CustomImageView(
                                      imagePath:
                                          ImageConstant.img0867344944x374,
                                      height: 944.h,
                                      width: double.maxFinite,
                                    ),
                                    _buildStacka65bbb3b63(context),
                                  ],
                                ),
                              ),
                            ),
  ...
  Widget _buildRowspacertwo(BuildContext context) {
    return Container(
      width: double.maxFinite,
      margin: EdgeInsets.only(left: 16.h, right: 16.h, bottom: 102.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.end,
        children: [
          Spacer(),
  ...
  Widget _buildRowuserone(BuildContext context) {
    return Container(
      width: double.maxFinite,
      margin: EdgeInsets.only(left: 8.h, right: 8.h, bottom: 120.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.end,
        children: [
          CustomImageView(
  ...
  /// Section Widget
  Widget _buildReceivedtwo(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildStacka65bbb3b63(BuildContext context) {
    return Align(
      alignment: Alignment.topCenter,
      child: Container(
        height: 392.h,
        margin: EdgeInsets.only(left: 14.h, top: 184.h, right: 14.h),
        child: Stack(
          alignment: Alignment.center,
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgA65bbb3b63d7cef228x232,
              height: 228.h,
              width: 234.h,
              alignment: Alignment.bottomCenter,
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: AppDecoration.fillBluegray900211.copyWith(
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomImageView(
                          imagePath: ImageConstant.imgCloseLightGreenA70024x24,
                          height: 24.h,
                          width: 24.h,
                        ),
                        Padding(
                          ...
                          child: Stack(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: AppDecoration.column407,
                                child: Column(
                                  spacing: 2,
                                  mainAxisSize: MainAxisSize.min,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              CustomImageView(
                                imagePath:
                                    ImageConstant.imgArrowRightOnprimary24x12,
                                height: 24.h,
                                width: 14.h,
                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      alignment: Alignment.center,
                      children: [
                        Text("lbl_get4".tr, style: theme.textTheme.titleMedium),
                        _buildReceivedtwo(context),
                      ],
                    ),
                  ),
