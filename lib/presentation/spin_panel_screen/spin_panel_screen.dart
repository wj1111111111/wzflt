...
import 'bloc/spin_panel_bloc.dart';
...
import 'widgets/listluckwheel_item_widget.dart';

class SpinPanelScreen extends StatelessWidget {
  const SpinPanelScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<SpinPanelBloc>(
      create:
          (context) =>
              SpinPanelBloc(SpinPanelState(spinPanelModelObj: SpinPanelModel()))
                ..add(SpinPanelInitialEvent()),
      child: SpinPanelScreen(),
    );
  }
                              ...
                              Align(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomImageView(
                                        imagePath: ImageConstant.imgCash138x40,
                                        height: 38.h,
                                        width: 42.h,
                                      ),
                                      Text(
  ...
  Widget _buildListluckwheel(BuildContext context) {
    return Align(
      alignment: Alignment.topRight,
      child: Container(
        margin: EdgeInsets.only(top: 108.h, right: 6.h),
        child: BlocSelector<SpinPanelBloc, SpinPanelState, SpinPanelModel?>(
          selector: (state) => state.spinPanelModelObj,
          builder: (context, spinPanelModelObj) {
            return SingleChildScrollView(
              ...
              child: Wrap(
                ...
                children: List.generate(
                  spinPanelModelObj?.listluckwheelItemList.length ?? 0,
                  (index) {
                    ListluckwheelItemModel model =
                        spinPanelModelObj?.listluckwheelItemList[index] ??
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          CustomImageView(
            imagePath: ImageConstant.img12250x254,
            height: 250.h,
            width: 256.h,
          ),
        ],
      ...
      child: BlocSelector<SpinPanelBloc, SpinPanelState, SpinPanelModel?>(
        ...
        builder: (context, spinPanelModelObj) {
          return ListView.separated(
            ...
            itemCount: spinPanelModelObj?.list123123ItemList.length ?? 0,
            itemBuilder: (context, index) {
              List123123ItemModel model =
                  spinPanelModelObj?.list123123ItemList[index] ??
                  List123123ItemModel();
