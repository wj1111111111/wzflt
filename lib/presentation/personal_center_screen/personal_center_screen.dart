...
import 'bloc/personal_center_bloc.dart';
...
class PersonalCenterScreen extends StatelessWidget {
  PersonalCenterScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<PersonalCenterBloc>(
      create:
          (context) => PersonalCenterBloc(
            PersonalCenterState(personalCenterModelObj: PersonalCenterModel()),
          )..add(PersonalCenterInitialEvent()),
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  width: double.maxFinite,
                  decoration: AppDecoration.column158,
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      CustomImageView(
        ...
        children: [
          Container(
            ...
            child: BlocSelector<
              ...
              PersonalCenterModel?
            >(
              selector: (state) => state.personalCenterModelObj,
              builder: (context, personalCenterModelObj) {
                return SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    children: List.generate(
                      personalCenterModelObj?.listbettingrecoItemList.length ??
                          0,
                      (index) {
        ...
        children: [
            ...
            >(
              ...
              builder: (context, personalCenterModelObj) {
                return ListView.separated(
                  ...
                  itemCount:
                      personalCenterModelObj?.listinviteOneItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    ListinviteOneItemModel model =
                        personalCenterModelObj?.listinviteOneItemList[index] ??
          ...
          Container(
            ...
            child: Row(
              children: [
                CustomImageView(
                  imagePath: ImageConstant.imgFrame14123,
                  height: 36.h,
                  width: 36.h,
                ),
                Align(
      ...
      child: Row(
        ...
        children: [
          ...
          CustomImageView(
            ...
            height: 8.h,
            width: 10.h,
            margin: EdgeInsets.only(top: 22.h, right: 2.h),
          ),
        ],
      ),
    );
