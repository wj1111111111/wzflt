...
/// This class is used in the [home_sms_popup_item_widget] screen.

// ignore_for_file: must_be_immutable
class HomeSmsPopupItemModel extends Equatable {
  ...
  HomeSmsPopupItemModel copyWith({
    String? fortuneOx,
    String? televisionOne,
    String? fortuneox1,
    String? id,
  }) {
    return HomeSmsPopupItemModel(
