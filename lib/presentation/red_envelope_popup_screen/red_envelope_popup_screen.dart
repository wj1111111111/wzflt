...
import 'bloc/red_envelope_popup_bloc.dart';
import 'models/red_envelope_popup_model.dart';

class RedEnvelopePopupScreen extends StatelessWidget {
  const RedEnvelopePopupScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<RedEnvelopePopupBloc>(
      create:
          (context) => RedEnvelopePopupBloc(
            RedEnvelopePopupState(
              redEnvelopePopupModelObj: RedEnvelopePopupModel(),
            ),
          )..add(RedEnvelopePopupInitialEvent()),
      child: RedEnvelopePopupScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RedEnvelopePopupBloc, RedEnvelopePopupState>(
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Text(
                                    "lbl_red_package".tr.toUpperCase(),
                                    style:
                                        CustomTextStyles
