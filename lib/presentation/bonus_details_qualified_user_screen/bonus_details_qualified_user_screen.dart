...
class BonusDetailsQualifiedUserScreen extends StatefulWidget {
  const BonusDetailsQualifiedUserScreen({Key? key}) : super(key: key);

  @override
  BonusDetailsQualifiedUserScreenState createState() =>
      BonusDetailsQualifiedUserScreenState();
          ...
          (context) => BonusDetailsQualifiedUserBloc(
            BonusDetailsQualifiedUserState(
              bonusDetailsQualifiedUserModelObj:
                  BonusDetailsQualifiedUserModel(),
            ),
          )..add(BonusDetailsQualifiedUserInitialEvent()),
      child: BonusDetailsQualifiedUserScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class BonusDetailsQualifiedUserScreenState
    extends State<BonusDetailsQualifiedUserScreen>
