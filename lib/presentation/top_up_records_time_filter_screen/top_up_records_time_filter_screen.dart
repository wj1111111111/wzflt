...
import 'bloc/top_up_records_time_filter_bloc.dart';
...
class TopUpRecordsTimeFilterScreen extends StatelessWidget {
  const TopUpRecordsTimeFilterScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<TopUpRecordsTimeFilterBloc>(
      create:
          (context) => TopUpRecordsTimeFilterBloc(
            TopUpRecordsTimeFilterState(
              topUpRecordsTimeFilterModelObj: TopUpRecordsTimeFilterModel(),
            ),
          )..add(TopUpRecordsTimeFilterInitialEvent()),
      child: TopUpRecordsTimeFilterScreen(),
    );
  }
  ...
  Widget _buildColumnarrowleft(BuildContext context) {
    return Container(
      ...
      decoration: AppDecoration.column379,
      child: Column(
        spacing: 30,
        children: [
          CustomAppBar(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: BlocSelector<
                TopUpRecordsTimeFilterBloc,
                TopUpRecordsTimeFilterState,
                TopUpRecordsTimeFilterModel?
              >(
                selector: (state) => state.topUpRecordsTimeFilterModelObj,
                builder: (context, topUpRecordsTimeFilterModelObj) {
        ...
        builder: (context, topUpRecordsTimeFilterModelObj) {
          return Wrap(
            ...
            children: List<Widget>.generate(
              topUpRecordsTimeFilterModelObj?.chipviewtodayItemList.length ?? 0,
              (index) {
