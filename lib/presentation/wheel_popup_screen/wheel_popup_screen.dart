...
import 'bloc/wheel_popup_bloc.dart';
import 'models/wheel_popup_model.dart';

class WheelPopupScreen extends StatelessWidget {
  const WheelPopupScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WheelPopupBloc>(
      create:
          (context) => WheelPopupBloc(
            WheelPopupState(wheelPopupModelObj: WheelPopupModel()),
          )..add(WheelPopupInitialEvent()),
      child: WheelPopupScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<WheelPopupBloc, WheelPopupState>(
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Text(
                                    "lbl_lucky_wheel".tr.toUpperCase(),
                                    style:
                                        CustomTextStyles
