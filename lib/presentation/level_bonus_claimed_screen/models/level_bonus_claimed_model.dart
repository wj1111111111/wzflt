...
/// This class defines the variables used in the [level_bonus_claimed_screen],
/// and is typically used to hold data that is passed between different parts of the application.

// ignore_for_file: must_be_immutable
class LevelBonusClaimedModel extends Equatable {
  ...
  LevelBonusClaimedModel copyWith({
    List<ListvipOneItemModel>? listvipOneItemList,
    List<ListfourOneItemModel>? listfourOneItemList,
    List<Listlv1OneItemModel>? listlv1OneItemList,
  }) {
    return LevelBonusClaimedModel(
