...
import 'bloc/level_bonus_claimed_bloc.dart';
...
class LevelBonusClaimedScreen extends StatelessWidget {
  const LevelBonusClaimedScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<LevelBonusClaimedBloc>(
      create:
          (context) => LevelBonusClaimedBloc(
            LevelBonusClaimedState(
              levelBonusClaimedModelObj: LevelBonusClaimedModel(),
            ),
          )..add(LevelBonusClaimedInitialEvent()),
      child: LevelBonusClaimedScreen(),
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "lbl_3".tr,
                                    style:
                                        CustomTextStyles.titleMediumYellow50002,
                                  ),
                                ),
                                Container(
                                  width: 54.h,
                ...
                BlocSelector<
                  LevelBonusClaimedBloc,
                  LevelBonusClaimedState,
                  LevelBonusClaimedModel?
                >(
                  selector: (state) => state.levelBonusClaimedModelObj,
                  builder: (context, levelBonusClaimedModelObj) {
    ...
    >(
      ...
      builder: (context, levelBonusClaimedModelObj) {
        return ListView.separated(
          ...
          itemCount: levelBonusClaimedModelObj?.listfourOneItemList.length ?? 0,
          itemBuilder: (context, index) {
            ListfourOneItemModel model =
                levelBonusClaimedModelObj?.listfourOneItemList[index] ??
