...
import 'bloc/spin_slice_files_bloc.dart';
...
import 'widgets/listluck_wheel_item_widget.dart';

class SpinSliceFilesScreen extends StatelessWidget {
  const SpinSliceFilesScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<SpinSliceFilesBloc>(
      create:
          (context) => SpinSliceFilesBloc(
            SpinSliceFilesState(spinSliceFilesModelObj: SpinSliceFilesModel()),
          )..add(SpinSliceFilesInitialEvent()),
      child: SpinSliceFilesScreen(),
    );
  }
                                    ...
                                    child: Container(
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          ...
                                          _buildStackticketeven(context),
                                          _buildStackonesix(context),
                                          _buildListluckwheel(context),
                                          Container(
                                            height: 472.h,
                                            child: Stack(
                                              alignment: Alignment.center,
                                          ...
                                          _buildStackonenine(context),
                                          Container(
                                            width: 298.h,
                                            padding: EdgeInsets.symmetric(
                                              horizontal: 48.h,
                                            ),
                                            decoration: AppDecoration.column443,
                                            child: Column(
                                              mainAxisSize: MainAxisSize.min,
                                              children: [
  ...
  /// Section Widget
  Widget _buildStackmembers(BuildContext context) {
    return Align(
      alignment: Alignment.bottomCenter,
      child: Container(
        height: 78.h,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: _buildColumnhome(
                            context,
                            imageNineteen: ImageConstant.imgNavDeposit25x26,
                      ...
                      Padding(
                        ...
                        child: _buildColumnhome(
                          context,
                          imageNineteen: ImageConstant.imgGroup13046,
        ...
        child: Stack(
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                width: double.maxFinite,
                margin: EdgeInsets.only(left: 6.h, top: 30.h, right: 6.h),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SizedBox(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: AppDecoration
                                      .gradientDeepPurpleAToDeeppurpleA10002
                                      .copyWith(
                                        borderRadius:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style:
                                            CustomTextStyles
                                                .labelLargeBluegray80013,
                                      ),
                                    ],
                                  ),
                                ),
                                CustomImageView(
                                  imagePath: ImageConstant.imgImage37736x40,
                                  height: 36.h,
                                  width: 42.h,
                                  alignment: Alignment.topCenter,
                                ),
  ...
  /// Section Widget
  Widget _buildListluckwheel(BuildContext context) {
    return Align(
      alignment: Alignment.topRight,
      child: Container(
        margin: EdgeInsets.only(top: 110.h, right: 6.h),
        child: BlocSelector<
          SpinSliceFilesBloc,
          SpinSliceFilesState,
          SpinSliceFilesModel?
        >(
          selector: (state) => state.spinSliceFilesModelObj,
          builder: (context, spinSliceFilesModelObj) {
            return SingleChildScrollView(
              ...
              child: Wrap(
                ...
                children: List.generate(
                  spinSliceFilesModelObj?.listluckWheelItemList.length ?? 0,
                  (index) {
                    ListluckWheelItemModel model =
                        spinSliceFilesModelObj?.listluckWheelItemList[index] ??
                        ListluckWheelItemModel();
                    return ListluckWheelItemWidget(model);
                  },
                ),
              ),
            );
            ...
            child: Stack(
              ...
              children: [
                ...
                CustomImageView(
                  ...
                  width: 118.h,
                  alignment: Alignment.topLeft,
                  margin: EdgeInsets.only(left: 64.h, top: 2.h),
                ),
              ],
            ),
          ),
  ...
  Widget _buildList123123(BuildContext context) {
    return Align(
      alignment: Alignment.bottomCenter,
      child: Container(
        margin: EdgeInsets.only(left: 24.h, right: 24.h, bottom: 46.h),
        ...
        >(
          ...
          builder: (context, spinSliceFilesModelObj) {
            return ListView.separated(
              ...
              itemCount: spinSliceFilesModelObj?.list123123ItemList.length ?? 0,
              itemBuilder: (context, index) {
                List123123ItemModel model =
                    spinSliceFilesModelObj?.list123123ItemList[index] ??
                    List123123ItemModel();
