...
import 'bloc/senior_mentoring_highest_level_bloc.dart';
...
class SeniorMentoringHighestLevelScreen extends StatelessWidget {
  const SeniorMentoringHighestLevelScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<SeniorMentoringHighestLevelBloc>(
      create:
          (context) => SeniorMentoringHighestLevelBloc(
            SeniorMentoringHighestLevelState(
              seniorMentoringHighestLevelModelObj:
                  SeniorMentoringHighestLevelModel(),
            ),
          )..add(SeniorMentoringHighestLevelInitialEvent()),
      child: SeniorMentoringHighestLevelScreen(),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: double.maxFinite,
                          child: BlocSelector<
                            SeniorMentoringHighestLevelBloc,
                            SeniorMentoringHighestLevelState,
                            SeniorMentoringHighestLevelModel?
                          >(
                            selector:
                                (state) =>
                                    state.seniorMentoringHighestLevelModelObj,
                            builder: (
                              context,
                              seniorMentoringHighestLevelModelObj,
                            ) {
                        ...
                        return CarouselSlider.builder(
                          options: CarouselOptions(
                            ...
                            onPageChanged: (index, reason) {
                              context
                                  .read<SeniorMentoringHighestLevelBloc>()
      ...
      child: Stack(
        ...
        children: [
          BlocSelector<
            ...
            SeniorMentoringHighestLevelModel?
          >(
            selector: (state) => state.seniorMentoringHighestLevelModelObj,
            builder: (context, seniorMentoringHighestLevelModelObj) {
