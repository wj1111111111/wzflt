...
import 'bloc/treasure_box_confirm_bloc.dart';
...
class TreasureBoxConfirmScreen extends StatelessWidget {
  const TreasureBoxConfirmScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<TreasureBoxConfirmBloc>(
      create:
          (context) => TreasureBoxConfirmBloc(
            TreasureBoxConfirmState(
              treasureBoxConfirmModelObj: TreasureBoxConfirmModel(),
            ),
          )..add(TreasureBoxConfirmInitialEvent()),
      child: TreasureBoxConfirmScreen(),
    );
  }
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        "lbl_golden_egg"
                                                                            .tr,
                                                                        style:
                                                                            CustomTextStyles.labelLargeBluegray80013,
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ),
      ...
      child: Stack(
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              width: double.maxFinite,
              margin: EdgeInsets.only(left: 6.h, top: 50.h, right: 6.h),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  CustomImageView(
  ...
  Widget _buildList123123(BuildContext context) {
    return Container(
      ...
      child: BlocSelector<
        TreasureBoxConfirmBloc,
        TreasureBoxConfirmState,
        TreasureBoxConfirmModel?
      >(
        selector: (state) => state.treasureBoxConfirmModelObj,
        builder: (context, treasureBoxConfirmModelObj) {
          return ListView.separated(
            ...
            itemCount:
                treasureBoxConfirmModelObj?.list123123ItemList.length ?? 0,
            itemBuilder: (context, index) {
              List123123ItemModel model =
                  treasureBoxConfirmModelObj?.list123123ItemList[index] ??
                  List123123ItemModel();
