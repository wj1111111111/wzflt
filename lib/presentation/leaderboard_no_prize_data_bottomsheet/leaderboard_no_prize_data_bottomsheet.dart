...
import 'bloc/leaderboard_no_prize_data_bloc.dart';
import 'models/leaderboard_no_prize_data_model.dart'; // ignore_for_file: must_be_immutable

class LeaderboardNoPrizeDataBottomsheet extends StatelessWidget {
  const LeaderboardNoPrizeDataBottomsheet({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<LeaderboardNoPrizeDataBloc>(
      create:
          (context) => LeaderboardNoPrizeDataBloc(
            LeaderboardNoPrizeDataState(
              leaderboardNoPrizeDataModelObj: LeaderboardNoPrizeDataModel(),
            ),
          )..add(LeaderboardNoPrizeDataInitialEvent()),
      child: LeaderboardNoPrizeDataBottomsheet(),
    );
  }
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: AppDecoration.column189,
                      child: Column(
