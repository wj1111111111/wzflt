...
import 'reportdataadd_tab_page.dart';

class ReportDataAddRankingBonusScreen extends StatefulWidget {
  const ReportDataAddRankingBonusScreen({Key? key}) : super(key: key);

  @override
  ReportDataAddRankingBonusScreenState createState() =>
      ReportDataAddRankingBonusScreenState();
          ...
          (context) => ReportDataAddRankingBonusBloc(
            ReportDataAddRankingBonusState(
              reportDataAddRankingBonusModelObj:
                  ReportDataAddRankingBonusModel(),
            ),
          )..add(ReportDataAddRankingBonusInitialEvent()),
      child: ReportDataAddRankingBonusScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class ReportDataAddRankingBonusScreenState
    extends State<ReportDataAddRankingBonusScreen>
              ...
              Expanded(
                child: Container(
                  child: TabBarView(
                    ...
                    children: [
                      ReportdataaddTabPage.builder(context),
                      ReportdataaddTabPage.builder(context),
                      ReportdataaddTabPage.builder(context),
                      ReportdataaddTabPage.builder(context),
                      ReportdataaddTabPage.builder(context),
