...
import 'bloc/wheel_spin_verify_phone_bloc.dart';
import 'models/wheel_spin_verify_phone_model.dart'; // ignore_for_file: must_be_immutable

class WheelSpinVerifyPhoneDialog extends StatelessWidget {
  const WheelSpinVerifyPhoneDialog({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WheelSpinVerifyPhoneBloc>(
      create:
          (context) => WheelSpinVerifyPhoneBloc(
            WheelSpinVerifyPhoneState(
              wheelSpinVerifyPhoneModelObj: WheelSpinVerifyPhoneModel(),
            ),
          )..add(WheelSpinVerifyPhoneInitialEvent()),
      child: WheelSpinVerifyPhoneDialog(),
    );
  }
  ...
  Widget _buildPhoneNumber(BuildContext context) {
    return SizedBox(
      width: double.maxFinite,
      child: BlocBuilder<WheelSpinVerifyPhoneBloc, WheelSpinVerifyPhoneState>(
        builder: (context, state) {
          return CustomPhoneNumber(
            ...
            onTap: (Country value) {
              context.read<WheelSpinVerifyPhoneBloc>().add(
