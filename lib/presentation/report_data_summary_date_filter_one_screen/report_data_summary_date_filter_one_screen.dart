...
class ReportDataSummaryDateFilterOneScreen extends StatefulWidget {
  const ReportDataSummaryDateFilterOneScreen({Key? key}) : super(key: key);

  @override
  ReportDataSummaryDateFilterOneScreenState createState() =>
      ReportDataSummaryDateFilterOneScreenState();
          ...
          (context) => ReportDataSummaryDateFilterOneBloc(
            ReportDataSummaryDateFilterOneState(
              reportDataSummaryDateFilterOneModelObj:
                  ReportDataSummaryDateFilterOneModel(),
            ),
          )..add(ReportDataSummaryDateFilterOneInitialEvent()),
      child: ReportDataSummaryDateFilterOneScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class ReportDataSummaryDateFilterOneScreenState
    extends State<ReportDataSummaryDateFilterOneScreen>
