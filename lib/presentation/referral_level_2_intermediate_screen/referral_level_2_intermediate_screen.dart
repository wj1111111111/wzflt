...
import 'bloc/referral_level_2_intermediate_bloc.dart';
...
class ReferralLevel2IntermediateScreen extends StatelessWidget {
  const ReferralLevel2IntermediateScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<ReferralLevel2IntermediateBloc>(
      create:
          (context) => ReferralLevel2IntermediateBloc(
            ReferralLevel2IntermediateState(
              referralLevel2IntermediateModelObj:
                  ReferralLevel2IntermediateModel(),
            ),
          )..add(ReferralLevel2IntermediateInitialEvent()),
      child: ReferralLevel2IntermediateScreen(),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: double.maxFinite,
                          child: BlocSelector<
                            ReferralLevel2IntermediateBloc,
                            ReferralLevel2IntermediateState,
                            ReferralLevel2IntermediateModel?
                          >(
                            selector:
                                (state) =>
                                    state.referralLevel2IntermediateModelObj,
                            builder: (
                              context,
                              referralLevel2IntermediateModelObj,
                            ) {
        ...
        child: BackdropFilter(
          ...
          child: Card(
            ...
            child: Container(
              height: 240.h,
              width: double.maxFinite,
              decoration: AppDecoration.gradientTealACToCyanC.copyWith(
                borderRadius: BorderRadiusStyle.circleBorder10,
              ),
              child: Stack(
                alignment: Alignment.center,
                        ...
                        return CarouselSlider.builder(
                          options: CarouselOptions(
                            ...
                            onPageChanged: (index, reason) {
                              context
                                  .read<ReferralLevel2IntermediateBloc>()
      ...
      child: Stack(
        ...
        children: [
          BlocSelector<
            ...
            ReferralLevel2IntermediateModel?
          >(
            selector: (state) => state.referralLevel2IntermediateModelObj,
            builder: (context, referralLevel2IntermediateModelObj) {
