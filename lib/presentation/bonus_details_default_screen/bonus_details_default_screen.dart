...
import 'scrollview_tab4_page.dart';

class BonusDetailsDefaultScreen extends StatefulWidget {
  const BonusDetailsDefaultScreen({Key? key}) : super(key: key);

  @override
  BonusDetailsDefaultScreenState createState() =>
      BonusDetailsDefaultScreenState();
  static Widget builder(BuildContext context) {
    return BlocProvider<BonusDetailsDefaultBloc>(
      create:
          (context) => BonusDetailsDefaultBloc(
            BonusDetailsDefaultState(
              bonusDetailsDefaultModelObj: BonusDetailsDefaultModel(),
            ),
          )..add(BonusDetailsDefaultInitialEvent()),
      child: BonusDetailsDefaultScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class BonusDetailsDefaultScreenState extends State<BonusDetailsDefaultScreen>
              ...
              Expanded(
                child: Container(
                  child: TabBarView(
                    ...
                    children: [
                      ScrollviewTab4Page.builder(context),
                      ScrollviewTab4Page.builder(context),
                      ScrollviewTab4Page.builder(context),
                      ScrollviewTab4Page.builder(context),
                      ScrollviewTab4Page.builder(context),
