...
import 'bloc/wallet_top_up_records_withdrawal_bloc.dart';
import 'models/wallet_top_up_records_withdrawal_model.dart';

class WalletTopUpRecordsWithdrawalScreen extends StatelessWidget {
  const WalletTopUpRecordsWithdrawalScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WalletTopUpRecordsWithdrawalBloc>(
      create:
          (context) => WalletTopUpRecordsWithdrawalBloc(
            WalletTopUpRecordsWithdrawalState(
              walletTopUpRecordsWithdrawalModelObj:
                  WalletTopUpRecordsWithdrawalModel(),
            ),
          )..add(WalletTopUpRecordsWithdrawalInitialEvent()),
      child: WalletTopUpRecordsWithdrawalScreen(),
    );
  }
