...
import 'bloc/state_2_this_round_ongoing_bloc.dart';
import 'models/state_2_this_round_ongoing_model.dart';

// ignore_for_file: must_be_immutable
class State2ThisRoundOngoingScreen extends StatelessWidget {
  State2ThisRoundOngoingScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<State2ThisRoundOngoingBloc>(
      create:
          (context) => State2ThisRoundOngoingBloc(
            State2ThisRoundOngoingState(
              state2ThisRoundOngoingModelObj: State2ThisRoundOngoingModel(),
            ),
          )..add(State2ThisRoundOngoingInitialEvent()),
      child: State2ThisRoundOngoingScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<State2ThisRoundOngoingBloc, State2ThisRoundOngoingState>(
                            ...
                            children: [
                              Align(
                                ...
                                child: Container(
                                  ...
                                  decoration: AppDecoration.column302,
                                  child: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Container(
                                          decoration: AppDecoration.row303,
                                          width: double.maxFinite,
                                          child: Row(
                                            mainAxisAlignment:
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    style:
                                                        CustomTextStyles
                                                            .displayMediumArialErrorContainer,
                                                  ),
                                                ),
                                              ),
                                              Spacer(),
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: AppDecoration.column304,
                                child: Column(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    CustomElevatedButton(
  ...
  Widget _buildRowthree(BuildContext context) {
    return Container(
      width: double.maxFinite,
      margin: EdgeInsets.only(left: 2.h, right: 14.h),
      child: Row(
        children: [
          Expanded(
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  CustomImageView(
                    ...
                    width: 70.h,
                    alignment: Alignment.bottomRight,
                    margin: EdgeInsets.only(right: 72.h, bottom: 42.h),
                  ),
                  CustomImageView(
                    imagePath: ImageConstant.img6563,
                    height: 70.h,
                  ...
                  CustomImageView(
                    ...
                    width: 54.h,
                    alignment: Alignment.topRight,
                    margin: EdgeInsets.only(top: 32.h, right: 96.h),
                  ),
                  CustomImageView(
                    imagePath: ImageConstant.img6567,
                    height: 52.h,
                  ...
                  CustomImageView(
                    ...
                    width: 46.h,
                    alignment: Alignment.topRight,
                    margin: EdgeInsets.only(top: 72.h, right: 14.h),
                  ),
                  CustomImageView(
                    ...
                    width: 46.h,
                    alignment: Alignment.topRight,
                    margin: EdgeInsets.only(top: 6.h, right: 54.h),
                  ),
                ],
              ),
            ),
