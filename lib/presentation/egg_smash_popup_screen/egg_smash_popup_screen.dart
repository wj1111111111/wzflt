...
import 'bloc/egg_smash_popup_bloc.dart';
import 'models/egg_smash_popup_model.dart';

class EggSmashPopupScreen extends StatelessWidget {
  const EggSmashPopupScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<EggSmashPopupBloc>(
      create:
          (context) => EggSmashPopupBloc(
            EggSmashPopupState(eggSmashPopupModelObj: EggSmashPopupModel()),
          )..add(EggSmashPopupInitialEvent()),
      child: EggSmashPopupScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<EggSmashPopupBloc, EggSmashPopupState>(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                "lbl_19_20".tr,
                                                                                style:
                                                                                    CustomTextStyles.headlineLargeYellow30008,
                                                                              ),
                                                                            ),
                                                                          ],
                                                                        ),
