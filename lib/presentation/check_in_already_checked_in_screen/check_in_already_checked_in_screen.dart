...
import 'bloc/check_in_already_checked_in_bloc.dart';
import 'models/check_in_already_checked_in_model.dart';

class CheckInAlreadyCheckedInScreen extends StatelessWidget {
  const CheckInAlreadyCheckedInScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<CheckInAlreadyCheckedInBloc>(
      create:
          (context) => CheckInAlreadyCheckedInBloc(
            CheckInAlreadyCheckedInState(
              checkInAlreadyCheckedInModelObj: CheckInAlreadyCheckedInModel(),
            ),
          )..add(CheckInAlreadyCheckedInInitialEvent()),
      child: CheckInAlreadyCheckedInScreen(),
    );
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: AppDecoration.column268,
                          child: Column(
                          ...
                          SizedBox(
                            ...
                            child: Stack(
                              ...
                              children: [
                                CustomImageView(
                                  imagePath:
                                      ImageConstant.img5dfa96056b444f540x38,
                                  height: 40.h,
                                  width: 40.h,
                                  alignment: Alignment.bottomCenter,
                                ),
                                ...
                                Container(
                                  ...
                                  decoration: AppDecoration.outlineAmberA4001
                                      .copyWith(
                                        borderRadius:
