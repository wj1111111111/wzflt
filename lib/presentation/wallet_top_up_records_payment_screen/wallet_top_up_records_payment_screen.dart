...
import 'bloc/wallet_top_up_records_payment_bloc.dart';
...
class WalletTopUpRecordsPaymentScreen extends StatelessWidget {
  const WalletTopUpRecordsPaymentScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WalletTopUpRecordsPaymentBloc>(
      create:
          (context) => WalletTopUpRecordsPaymentBloc(
            WalletTopUpRecordsPaymentState(
              walletTopUpRecordsPaymentModelObj:
                  WalletTopUpRecordsPaymentModel(),
            ),
          )..add(WalletTopUpRecordsPaymentInitialEvent()),
      child: WalletTopUpRecordsPaymentScreen(),
    );
  }
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              CustomImageView(
                                imagePath: ImageConstant.imgGroup967,
                                height: 686.h,
                                width: double.maxFinite,
                              ),
                            ],
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: BlocSelector<
                WalletTopUpRecordsPaymentBloc,
                WalletTopUpRecordsPaymentState,
                WalletTopUpRecordsPaymentModel?
              >(
                selector: (state) => state.walletTopUpRecordsPaymentModelObj,
                builder: (context, walletTopUpRecordsPaymentModelObj) {
