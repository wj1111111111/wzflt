...
class BonusDetailsDepositBonusScreen extends StatefulWidget {
  const BonusDetailsDepositBonusScreen({Key? key}) : super(key: key);

  @override
  BonusDetailsDepositBonusScreenState createState() =>
      BonusDetailsDepositBonusScreenState();
      ...
      create:
          (context) => BonusDetailsDepositBonusBloc(
            BonusDetailsDepositBonusState(
              bonusDetailsDepositBonusModelObj: BonusDetailsDepositBonusModel(),
            ),
          )..add(BonusDetailsDepositBonusInitialEvent()),
      child: BonusDetailsDepositBonusScreen(),
    );
  }
}

// ignore_for_file: must_be_immutable
class BonusDetailsDepositBonusScreenState
    extends State<BonusDetailsDepositBonusScreen>
