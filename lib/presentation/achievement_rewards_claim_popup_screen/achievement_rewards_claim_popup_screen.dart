...
import 'bloc/achievement_rewards_claim_popup_bloc.dart';
import 'models/achievement_rewards_claim_popup_model.dart';

class AchievementRewardsClaimPopupScreen extends StatelessWidget {
  const AchievementRewardsClaimPopupScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<AchievementRewardsClaimPopupBloc>(
      create:
          (context) => AchievementRewardsClaimPopupBloc(
            AchievementRewardsClaimPopupState(
              achievementRewardsClaimPopupModelObj:
                  AchievementRewardsClaimPopupModel(),
            ),
          )..add(AchievementRewardsClaimPopupInitialEvent()),
      child: AchievementRewardsClaimPopupScreen(),
    );
  }
  ...
  Widget _buildColumnconfirm(BuildContext context) {
    return ImageFiltered(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [SizedBox(height: 32.h), _buildConfirm(context)],
        ),
      ),
    );
  }
  ...
  /// Section Widget
  Widget _buildColumncongratul(BuildContext context) {
    return Container(
      width: double.maxFinite,
      ...
      child: Column(
        ...
        mainAxisSize: MainAxisSize.min,
        children: [
          Text("lbl_388_00".tr, style: CustomTextStyles.headlineLargeAmberA400),
          Text(
