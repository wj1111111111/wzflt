...
class FrontScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<FrontBloc>(
      create:
          (context) =>
              FrontBloc(FrontState(frontModelObj: FrontModel()))
                ..add(FrontInitialEvent()),
      child: FrontScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<FrontBloc, FrontState>(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: AppDecoration.column243,
                                          child: Column(
                                            mainAxisSize: MainAxisSize.min,
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  CustomImageView(
                                    imagePath: ImageConstant.imgNavTeams,
                                    height: 20.h,
                                    width: 18.h,
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    appTheme.black900.withValues(alpha: 0.37),
                    appTheme.gray90030,
                  ],
                ),
              ),
                      ...
                      Container(
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: "msg_we_want_to_add_jbet88".tr,
                                style: CustomTextStyles.bodyMediumBluegray200,
                              ),
                              TextSpan(
                                text: "msg_screen_get_free".tr,
                                style: CustomTextStyles.bodyMediumBluegray20015,
                              ),
                            ],
                          ),
                          textAlign: TextAlign.left,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: AppDecoration
                                  .gradientLightGreenAToLightgreen90008
                                  .copyWith(
                                    borderRadius:
