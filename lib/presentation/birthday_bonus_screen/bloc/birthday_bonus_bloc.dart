...
part 'birthday_bonus_event.dart';
part 'birthday_bonus_state.dart';

/// A bloc that manages the state of a BirthdayBonus according to the event that is dispatched to it.
class BirthdayBonusBloc extends Bloc<BirthdayBonusEvent, BirthdayBonusState> {
  BirthdayBonusBloc(BirthdayBonusState initialState) : super(initialState) {
    on<BirthdayBonusInitialEvent>(_onInitialize);
  }

  _onInitialize(
    BirthdayBonusInitialEvent event,
    Emitter<BirthdayBonusState> emit,
  ) async {
    emit(
      state.copyWith(
        birthdayBonusModelObj: state.birthdayBonusModelObj?.copyWith(
